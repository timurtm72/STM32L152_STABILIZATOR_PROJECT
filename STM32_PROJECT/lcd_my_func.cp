#line 1 "G:/MY PROJECTS/Stabilizator/STM32_PROJECT/lcd_my_func.c"
...
void LCD_bar_status();
void clear_LCD();
#line 1 "g:/my projects/stabilizator/stm32_project/glass_lcd.c"
#line 1 "g:/my projects/stabilizator/stm32_project/glass_lcd.h"
#line 1 "g:/my projects/stabilizator/stm32_project/glass_lcd_def.h"
#line 109 "g:/my projects/stabilizator/stm32_project/glass_lcd.h"
...
#line 1 "g:/my projects/stabilizator/stm32_project/gpio.h"
#line 1 "g:/my projects/stabilizator/stm32_project/glass_lcd_def.h"
#line 5 "g:/my projects/stabilizator/stm32_project/glass_lcd.c"
void LCD_GLASS_Init()
{
 ...
 LCD_Master_Reset();
  ...
  do{LCD_FCR &= (~(0x3 << 0xA)); LCD_FCR |= ( 0x0  << 0xA);}while(0) ;
...
void LCD_RAM_clear()
{
 LCD_RAM_COM0 = 0x00000000;
 LCD_RAM_COM1 = 0x00000000;
 LCD_RAM_COM2 = 0x00000000;
 LCD_RAM_COM3 = 0x00000000;
 LCD_RAM_COM4 = 0x00000000;
 LCD_RAM_COM5 = 0x00000000;
 LCD_RAM_COM6 = 0x00000000;
 LCD_RAM_COM7 = 0x00000000;
}
...
#line 5 "G:/MY PROJECTS/Stabilizator/STM32_PROJECT/lcd_my_func.c"
...
void Out_data_to_LCD(char str_start,char str_end,float process_value)
{
 ...
 p1 = modf(process_value, &p2);
 convert_char = (unsigned int)p2;

 strDisp[0] = str_start;
 LCD_GLASS_WriteChar(&strDisp[0], 0x0 , 0x0 ,1);

 strDisp[1]= ' ';
 LCD_GLASS_WriteChar(&strDisp[1], 0x0 , 0x0 ,2);
 ...
 LCD_GLASS_WriteChar(&strDisp[2], 0x0 , 0x0 ,3);
 ...
 LCD_GLASS_WriteChar(&strDisp[3], 0x0 , 0x0 ,4);

 strDisp[4]= ((temp1 - ((temp1/10)*10))+48);
 LCD_GLASS_WriteChar(&strDisp[4], 0x0 , 0x0 ,5);

 strDisp[5]= str_end;
 LCD_GLASS_WriteChar(&strDisp[5], 0x0 , 0x0 ,6);
}
...
void LCD_bar_status()
{
 if(RELE_1) t_bar[0x1] |= 0x8 ;
 if(!RELE_1) t_bar[0x1] &= ~0x8 ;

 if(RELE_2) t_bar[0x0] |= 0x8 ;
 if(!RELE_2) t_bar[0x0] &= ~0x8 ;

 if(RELE_BYPASS) t_bar[0x1] |= 0x2 ;
 if(!RELE_BYPASS) t_bar[0x1] &= ~0x2 ;

 if(RELE_OUT_MAIN) t_bar[0x0] |= 0x2 ;
 if(!RELE_OUT_MAIN) t_bar[0x0] &= ~0x2 ;
 LCD_bar();
}
